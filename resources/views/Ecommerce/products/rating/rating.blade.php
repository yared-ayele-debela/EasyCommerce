<div class="modal fade" id="EcommerceratingModal" tabindex="-1" aria-labelledby="EcommerceratingModalLabel" aria-hidden="true">
...
<script>
    document.getElementById("ratingForm").addEventListener("submit", function(event) {
        ...
        fetch("{{ route('ecommerce.product.rate') }}", {
            method: "POST",
            headers: {
        ...
        .then(data => {
            if (data.status === "success") {
                ...
                $('#EcommerceratingModal').modal('hide'); // Close the modal
