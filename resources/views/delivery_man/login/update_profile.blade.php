        ...
        <div class="card-body pt-3">
            ...
            <ul class="nav nav-tabs pb-4 align-items-end card-header-tabs w-100">
                <li class="nav-item border-none">
                    <a class="nav-link active bg-light" href=""><i class=" fas fa-plus"></i>Update My Profile</a>
                </li>

            </ul>
            <div class="row">
                <div class="col-md-6">
                    <form action="{{ url('delivery-boy/update-profile-information') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <input type="hidden" name="id" value="{{ Auth::guard('deliverymen')->user()->id }}">
        ...
        <div class="row">
            ...
            <div class="col-md-5">
                <div class="form-group m-3">
                    ...
                    <input type="text" name="vehicle_capacity" value="{{ $deliveryman->vehicle_type }}" id="vehicle_capacity" class="form-control" required>
