    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <div class="form-group mb-2">
            ...
            <select class="form-control" style="background-color: #F6F9FF;color:#4154F1;" id="dashboardSwitcher">
                ...
                <option @if(request()->is('admin/restaurant/dashboard')) selected @endif value="{{ url('admin/restaurant*') }}">Restaurant Dashboard</option>
                <option @if(request()->is('admin/hotel/dashboard')) selected @endif value="{{ url('admin/hotel*') }}">Hotel Dashboard</option>
            </select>
        </div>
