...
<div class="container my-4">
    ...
    <div class="row g-3">
        ...
        <div class="d-flex justify-content-start mt-3">
            <img src="{{$restaurant->cover }}" width="100" class="thumbnail mx-2 p-2 border rounded" alt="{{ $restaurant->name }}" style="cursor: pointer;">
            @foreach($restaurant->images as $key => $image)
            <img src="{{$image->image_path}}" width="100" class="thumbnail mx-2 p-2 border rounded" alt="{{ $restaurant->name }}" style="cursor: pointer;">
            @endforeach
        </div>
    ...
    <nav class="d-flex justify-content-center align-items-center py-4">
        <div class="nav nav-pills resturant-detail-nav" id="nav-tab" role="tablist">
            ...
            <button class="nav-link" id="nav-category-tab" data-bs-toggle="tab" data-bs-target="#nav-category" type="button" role="tab" aria-controls="nav-category" aria-selected="false">Categories</button>
        </div>
    </nav>
