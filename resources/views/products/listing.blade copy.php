                            ...
                            <div class="select-box-wrapper">
                                ...
                                <select class="select-box" name="sort" id="sortproo" class="relevant_sort">
                                    ...
                                    <option value="price_lowest" @if(isset($_GET['sort'])&&
                                        $_GET['sort']=="price_lowest" ) selected="" @endif>Sort By: Lowest Price
                                    </option>
                                    <option value="price_heighst" @if(isset($_GET['sort'])&&
                                        $_GET['sort']=="price_heighst" ) selected="" @endif>Sort By: Highest Price
                                    </option>
                                    <option value="sort_a_z" @if(isset($_GET['sort'])&& $_GET['sort']=="sort_a_z" )
                                        selected="" @endif>Sort By:Name A-Z</option>
                                    <option value="sort_z_a" @if(isset($_GET['sort'])&& $_GET['sort']=="sort_z_a" )
