                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="city" id="city">
                                        @foreach ($city as $city)
                                            <option @if($city->name == $users->city) selected @endif  value="{{ $city->name }}">{{ $city->name }}</option>
                                        @endforeach
                                    </select>
                                    @error('city')
                                        <small class="text-danger">{{ $message }}</small>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="state" id="state">
                                        @foreach ($state as $state)
                                            <option @if($state->name == $users->state) selected @endif  value="{{ $state->name }}">{{ $state->name }}</option>
                                        @endforeach
                                    </select>
                                    @error('state')
                                        <small class="text-danger">{{ $message }}</small>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="country" id="country">
                                        @foreach ($country as $country)
                                            <option @if($country->country_name == $users->country) selected @endif  value="{{ $country->country_name }}">{{ $country->country_name }}</option>
                                        @endforeach
                                    </select>
                                    @error('country')
                                        <small class="text-danger">{{ $message }}</small>
