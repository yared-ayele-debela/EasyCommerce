...
<div class="pagetitle bg-light">
    <nav>
        <ol class="breadcrumb p-3 ">
            ...
            <li class="breadcrumb-item">Update color</li>
        </ol>
    </nav>
</div>
        ...
        <div class="card-body pt-3">
            ...
            <ul class="nav nav-tabs pb-4 align-items-end card-header-tabs w-100">
                <li class="nav-item border-none">
                    <a class="nav-link active bg-light" href="javascript:void(0);"><i class=" fas fa-plus"></i>Update color</a>
                </li>
            ...
            <form class=" g-3" action="{{ route('update-color') }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="row">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <input type="color" class="form-control" value="{{ $color->color }}" name="color">
                    @error('color')
                    <small class=" text-danger">{{ $message }}</small>
                    @enderror
                </div>
