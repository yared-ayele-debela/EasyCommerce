...
<body>
        ...
        <div class="head-title">
            <h1 class="text-center m-0 p-0">Good Receiving Note</h1>
        ...
        <div class="table-section bill-tbl w-100 mt-10">
            <table class="table w-100 mt-10">
                <tr>
                    <th class="w-50">From : {{ $stock_products->deliveryMan->first_name }} {{ $stock_products->deliveryMan->first_name }} (Delivery boy) </th>
                    <th class="w-50">To : {{ $stock_products->transfer_stock_product->toWarehouse->name }} (Warehouse)</th>
