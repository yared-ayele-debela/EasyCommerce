                ...
                <div class="row">
                    <div class="col">
                        ...
                        <div class="form-group ">
                            <label class="col-sm-3 col-from-label" for="name">Title <i class="las la-language text-danger" title="Translatable"></i></label>
                            <div class="col-sm-9">
                    ...
                    <div class="col">
                      ...
                      <div class="form-group ">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control aiz-date-range" name="start_date" id="start_date" value="{{ $flash_deal->start_date }}" placeholder="Select Start Date" autocomplete="off" required>
                      ...
                      <div class="form-group ">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control aiz-date-range" name="end_date"  id="end_date" value="{{ $flash_deal->end_date}}" placeholder="Select Start Date" autocomplete="off" required>
                          ...
                          <div class="col-sm-9">
                              <select name="products[]" id="products" class="form-control aiz-selectpicker" multiple required data-placeholder="Choose Products" data-live-search="true" data-selected-text-format="count">
                                  @foreach(\App\Models\Product::where('status', 1)->get() as $product)
                                      ...
                                      @endphp
                                      <option value="{{$product->id}}" <?php if($flash_deal_product != null) echo "selected";?> >{{ $product->product_name }}</option>
                                  @endforeach
                              </select>
                              <br>
