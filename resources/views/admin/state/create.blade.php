        ...
        <div class="card-body pt-3">
            ...
            <ul class="nav nav-tabs pb-4 align-items-end card-header-tabs w-100">
                <li class="nav-item border-none">
                    <a class="nav-link active bg-light" href="javascript:void(0);"><i class=" fas fa-plus"></i>Add state</a>
                </li>
            ...
            <form class=" g-3" action="{{ route('store-state') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="col-md-12">
