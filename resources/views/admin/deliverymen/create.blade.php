...
<div class="pagetitle bg-light">
    <nav>
        <ol class="breadcrumb p-3 ">
            ...
            <li class="breadcrumb-item">Add Delivery Boy</li>
        </ol>
    </nav>
</div>
<section class="section col-md-12">
    <div class="card border-0">
        <div class="card-body pt-3">
            ...
            <div class="row">
                <div class="col-md-6">
                    <form action="{{ route('delivery_boy.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
            ...
            <div class="row">
                    ...
                    <div class="form-group m-3">
                        <div class="form-group m-3">
                            ...
                            <select class="form-control" name="delivery_man_type" id="delivery_man_type">
                                ...
                                <option value="{{ $delivery_man_type->name }}">{{ $delivery_man_type->name }}</option>
                                @endforeach
                            </select>
                        </div>
                ...
                <div class="col-md-5">
                    <div class="form-group m-3">
                        ...
                        <input type="text" name="vehicle_capacity" id="vehicle_capacity" class="form-control" required>
