...
<head>
    ...
    <a href="{{ route('order-product-reports') }}" class="btn btn-primary m-1  ">
    ...
    <title>Order Product Quantity Chart</title>
            ...
            var chart = new CanvasJS.Chart("chartContainer", {
                ...
                data: [{
                    ...
                    dataPoints: [
                        ...
                        { y: {{ $data->total_quantity }}, label: "{{ $data->product_name }}" },
                        @endforeach
                    ]
                }]
            });
