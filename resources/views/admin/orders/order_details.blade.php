            ...
            <div class="card shadow-sm border-0">
                <div class="card-body pt-1">
                    ...
                    <div class="col-md-8 pt-1">
                     ...
                     @if(isset($orderDetails['payment_info']))
                    <div class="">
                        <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#Reservation{{ $orderDetails['id'] }}">
                            <i class="bi bi-eye-fill"></i> Payment information
                        </button> &nbsp;
                    </div>
                    <div class="modal fade" id="Reservation{{ $orderDetails['id'] }}" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-scrollable" role="document">
                            <div class="modal-content ">
                                ...
                                <div class="modal-body text-left">
                                    <p>Receipt:</p>
                                    @if(isset($orderDetails['payment_info']['receipt']))
                                    <img src="{{ asset('storage/'.$orderDetails['payment_info']['receipt']) }}" class="img-fluid" alt="{{ $orderDetails['payment_info']['bank_name'] }}">
                                    @else
                                    <img src="{{ asset('restaurant_frontend/default-image.png') }}" class="img-fluid" alt="{{ $orderDetails['payment_info']['bank_name'] }}">
                                    @endif
                                    <p class="card-text"><strong>Bank Name :</strong> {{ $orderDetails['payment_info']['bank_name'] }}</p>
                                    <p class="card-text"><strong>Transaction Number :</strong> <strong>{{ $orderDetails['payment_info']['transaction_number'] }}</strong></p>
                                    <p class="card-text"><strong>Amount Paid :</strong> {{ $orderDetails['payment_info']['amount_paid'] }} ETB</p>
                                    <p class="card-text text-dark"><strong>Payment Status :</strong> <span class="btn btn-sm btn btn-secondary">{{ $orderDetails['payment_info']['payment_status'] }}</span></p>
                                </div>
                    ...
                    @else
                    @endif
                    <h1 class="card-title mb-2">Update Order Payment Status</h1>
                    <form action="{{ url('admin/update-order-payment-status') }}" class="d-flex flex-column" method="post">
                        @csrf
                        <div class="form-group">
                            <input type="hidden" name="order_id" value="{{ $orderDetails['id'] }}">
                            <select name="order_status" id="order_status" class="form-control" required="">
                                <option value="" selected>Select</option>
                                <option value="pending" @if($orderDetails['payment_status']==="pending") selected @endif>Pending</option>
                                <option value="confirmed" @if( $orderDetails['payment_status']==="confirmed") selected @endif>Confirmed</option>
                                <option value="declined" @if($orderDetails['payment_status']==="declined") selected @endif>Declined</option>
                            </select>
                        </div>
                        ...
                        <div class="card-body bg-light m-3">
                            ...
                            ?> --}}
                                ...
                                <a class="btn bg-light shadow-sm" href="https://www.google.com/maps?q={{ $userDetails['latitude'] }},{{ $userDetails['longitude'] }}" target="_blank">
                                    <svg id='Home_Address_16' width='16' height='16' viewBox='0 0 16 16' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink'>
                                ...
                                <a class="btn bg-light shadow-sm" href="https://www.google.com/maps?q={{ $vendor->latitude }},{{ $vendor->longitude }}" target="_blank">
                                    <svg id='Shop_Location_16' width='16' height='16' viewBox='0 0 16 16' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink'>
                                        <rect width='16' height='16' stroke='none' fill='#000000' opacity='0' />
                                ...
                                <a class="btn btn-success" href="https://www.google.com/maps/dir/?api=1&origin={{ $vendor->latitude }},{{ $vendor->longitude }}&destination={{ $lat1 }},{{ $lon1 }}" target="_blank">
                                    <svg id='Direction_16' width='16' height='16' viewBox='0 0 16 16' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink'>
                                        <rect width='16' height='16' stroke='none' fill='#000000' opacity='0' />
                                ...
                                <div class="btn btn-primary"><strong><svg id='Location_16' width='16' height='16' viewBox='0 0 16 16' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink'>
                                            <rect width='16' height='16' stroke='none' fill='#000000' opacity='0' />
