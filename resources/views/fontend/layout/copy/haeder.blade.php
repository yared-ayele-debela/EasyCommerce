                                            ...
                                            <div class="card-body border-0 bg-white">
                                                <div class="field_wrapper mb-1">
                                                    ...
                                                    <div class="row mb-1">
                                                        ...
                                                        <div class="col-md-4 mb-1">
                                                            <textarea name="description[]" class="form-control" id="" cols="20" rows="3" placeholder="Product description" >
                                                            </textarea>
            ...
            <div class="row clearfix align-items-center">
                ...
                <div class="col-lg-6 u-d-none-lg">
                    <form class="form-searchbox" action="{{ url('/search-products') }}" method="get">
                        ...
                        <input id="search-landscape" type="text" class="text-field"  placeholder="Search product..." name="search" required type="text" @if(isset($_REQUEST['search']) &&
                        !empty($_REQUEST['search'])) value={{ $_REQUEST['search']}} @endif autocomplete="off">
                        <div class="select-box-position">
                            <div class="select-box-wrapper select-hide">
                                ...
                                <select class="select-box" name="section_id">
                                    ...
                                    <option  @if(isset($_REQUEST['section_id']) &&
                                    !empty($_REQUEST['section_id']) && $_REQUEST['section_id']==$group['id']) selected="" @endif value="{{ $group['id'] }}">{{ $group['name'] }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
