        ...
        <div id="imageSlider" class="carousel slide "  data-ride="carousel">
          ...
          <div class="carousel-inner">
            ...
            <div class="carousel-item  {{ $index === 0 ? 'active' : '' }}">
                <img src="{{ asset('/storage/banner/'.$banner['image']) }}" alt="Slider Image {{ $index + 1 }}" style="border-radius: 0.2rem;" class="d-block w-100 h-100 ">
        ...
        <div class="row">
            ...
            <div class="col-md-4 pb-3">
                <div class="category-position d-flex flex-column">
                    @if (Storage::exists('public/category/'.$category['banner_image']))
                    <img src="{{ asset('/storage/category/'.$category['banner_image']) }}" class="img-fluid h-100 shadow-sm" style="border-radius: 0.2rem;" alt="Category Image">
                    @else
                    <img src="{{ asset('default/default_banner_category.png') }}" class="img-fluid h-100 shadow-sm" style="border-radius: 0.2rem;" alt="Category Image">
                    @endif
            ...
            <div class="col-lg-3 col-12 col-md-4 mb-4" style="border: none;">
                <div class="card d-flex flex-column h-100" style="border:0.3px solid #e7f2f1;">
                    <div class="position-relative">
                        ...
                        @else
                        <img src="{{ asset('admin/no_image.jpg') }}" class="seller-image shadow-sm" alt="Seller Image">
                        @endif
                        ...
                        @else
                        <img src="{{ asset('admin/no.jpg') }}" class="card-img-top store-banner" alt="Seller Banner">
                        @endif
    ...
    @if(isset($fixbanners[0]['image']))
      <div class="col-md-6">
        <div class="banner mb-4">
          <!-- Content for first banner with image -->
...
{{-- <div class="banner-layer"> --}}
    <div class="container">
        <div class="image-banner">
            <a href="javascript:void();" class="mx-auto banner-hover effect-dark-opacity">
