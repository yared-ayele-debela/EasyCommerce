                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 u-s-p-x-0">
                        <div class="newsletter-image">
                            <a href="shop-v1-root-category.html" class="banner-hover effect-dark-opacity">
                                <img class="img-fluid" src="{{asset('new_frontend/images/banners/newsletter-1.jpg')}}" alt="Newsletter Image">
                            </a>
                        </div>
                    </div>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <!-- Product-zoom-area -->
                        <div class="zoom-area">
                            <img id="zoom-pro-quick-view" class="img-fluid" src="{{asset('new_frontend/images/product/product@4x.jpg')}}" data-zoom-image="images/product/product@4x.jpg')}}" alt="Zoom Image">
                            <div id="gallery-quick-view" class="u-s-m-t-10">
                                <a class="active" data-image="images/product/product@4x.jpg')}}" data-zoom-image="images/product/product@4x.jpg')}}">
                                    <img src="{{asset('new_frontend/images/product/product@2x.jpg')}}" alt="Product">
                                </a>
