...
<div class="container p-3 mt-3 shadow-sm">
    <div class="rounded p-4" style="background-color:#E7F2F1">
        <div class="row align-items-center">
            <div class="col-md-8">
                <h1 class="" style="color:#1E665E; font-size:20px;"><b>Category Products ({{ $category['name'] }})</b></h1>
                <p  style="color:#1E665E;">
                    @php $productCount=Product::productCount($category['id']) @endphp
                {{$productCount === 0 ? "" : "($productCount)" }} Items found</p>
            </div>
...
{{-- <section class="section-maker mt-3"> --}}
    <div class="container p-4 shadow-sm mb-3">
        <div class=" text-left ">
            <h3 class="sec-maker-h3">{{ $category['name'] }} PRODUCTS</h3>
        </div>
