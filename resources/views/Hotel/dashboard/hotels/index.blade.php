                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <ul class="list-inline">
                                ...
                                <a href="javascript:void(0);" class="mb-1 rounded rounded-3 text-dark btn-outline-dark list-inline-item">
                                    <img src="{{ asset('storage/' . $amenities[$key]->icon) }}" alt="{{ $amenities[$key]->name }}" width="24" height="24">
