...
@props(['restaurant', 'lat', 'lng'])
{{-- GRID ITEM --}}
<div class="col-lg-6 col-md-6 mb-2">
    {{-- CARD --}}
    <div class="offer-card h-100 overflow-hidden" data-lat="{{ $lat }}" data-lng="{{ $lng }}">
        <div class="row g-0 align-items-stretch">
            {{-- ⬅️ IMAGE COLUMN --}}
            <div class="col-4 col-sm-4">
                <a href="{{ url('restaurant/' . $restaurant->id . '/detail') }}" class="h-100 d-block">

                    <img src="{{ asset('storage/' . $restaurant->cover) ?? asset('restaurant_frontend/default-image.png') }}"
                         alt="{{ $restaurant->name }}"
