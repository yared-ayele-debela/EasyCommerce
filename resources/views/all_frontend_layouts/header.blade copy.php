...
<body>
    ...
    <!-- Splash Screens -->
    <div class="splash-screen" id="splash1"
        style="background-image: url({{ asset('restaurant_frontend/assets/img/1.jpg') }})" id="splash1">
    ...
    <div class="splash-screen" id="splash2"
        style="background-image: url({{ asset('restaurant_frontend/assets/img/2.jpg') }})">
        <button class="skip-btn" onclick="skipAll()">Skip</button>
    ...
    <div class="splash-screen" id="splash3"
        style="background-image: url({{ asset('restaurant_frontend/assets/img/3.jpg') }})">
        <button class="skip-btn" onclick="skipAll()">Skip</button>
    ...
    <div class="splash-screen" id="splash4"
        style="background-image: url({{ asset('restaurant_frontend/assets/img/4.jpg') }})">
        <button class="skip-btn" onclick="skipAll()">Skip</button>
    ...
    <div class="main-content" id="main">
                    ...
                    <div class="row align-items-center text-center text-md-start">
                        <div class="col-md-6 d-none d-md-block  mb-2 mb-md-0">
                            <div
                                ...
                                <small class="text-muted">
                                    <i
                                        class="bi bi-envelope-fill text-primary me-1"></i>{{ $appsetting['email_address'] }}
                                </small>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div
                                class="d-flex flex-md-row justify-content-between justify-content-md-end align-items-center gap-2">
            ...
            <div class="py-2 py-md-3 bg-white shadow-sm">
                <div class="container d-flex align-items-center justify-content-between">
                    <a href="{{ url('/') }}" class="d-flex align-items-center text-decoration-none">
                        <img src="{{ $appsetting['logo']?? asset('restaurant_frontend/assets/img/logo.png') }}"
                    ...
                    <form class="responsive-form">
                        <div class="input-group position-relative border border-1 rounded rounded-2">
                            ...
                            {{-- Search box --}}
                            <input class="form-control search-input border-0" id="search-box" name="query" type="search"
                                placeholder="Search products, food, rooms..." autocomplete="off">
                        ...
                        <div id="search-results"
                            class="list-group position-absolute w-100 shadow-sm bg-white rounded d-none"
                    ...
                    <div class="d-none d-md-flex align-items-center">
                        ...
                        @php
                        $wishlistCount = Auth::check() ? \App\Models\Restaurant\Wishlist::where('user_id',
                        Auth::id())->count() : 0;
                        $ecommerce_wishlistCount = Auth::check() ? \App\Models\Wishlist::where('user_id',
                        Auth::id())->count() : 0;
                        ...
                        @endphp
                        <a href="{{ route('restaurant.wishlist.index') }}"
                            class="btn btn-light btn-sm position-relative me-2">
                        ...
                        @if(Auth::check())
                        <div class="dropdown">
                            <a class="btn btn-light btn-sm" href="#" id="accountDropdown" role="button"
                                data-bs-toggle="dropdown" aria-expanded="false">
                                @if(Auth::user()->profile_photo_path)
                                <img src="{{ auth()->user()->profile_photo_path }}" width="28"
                            ...
                            <ul class="dropdown-menu dropdown-menu-end shadow">
                                <li>
                                    <a class="dropdown-item d-flex justify-content-between align-items-center"
                                        ...
                                        <span id="notification-badge1" class="badge bg-danger rounded-pill"
                                            style="display: none;">0<span>
                                    </a>
                                </li>
                                <li><a class="dropdown-item" href="{{ url('user/account/update') }}"><i
                                            class="bi bi-gear text-primary"></i> My Profile</a></li>
                                <li><a class="dropdown-item" href="{{ url('my-orders') }}"><i
                                            class="bi bi-bag text-primary"></i> My Orders</a></li>
                                <li><a class="dropdown-item" href="{{ url('my-delivery-addresses') }}"><i
                                            class="bi bi-geo-alt text-primary"></i> My Addresses</a></li>
                                <li>
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="dropdown-item" href="{{ route('vendor-register') }}"> Become A Vendor</a>
                                </li>
                                <li><a class="dropdown-item" href="{{ url('register/delivery-man') }}"> Become A
                                        Delivery Man</a></li>
                            </ul>
                        </div>
                        @endif
                        <button class="btn btn-light d-lg-none btn-sm ms-2" type="button" data-bs-toggle="offcanvas"
                ...
                <div class="container">
                    <div class="collapse navbar-collapse show">
                        <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
                            <li class="nav-item"><a class="nav-link {{ request()->is('/')?' custom-nav-active':'' }}"
                                    href="{{ url('/') }}">Home</a></li>
                            <li class="nav-item"><a
                                    class="nav-link {{ request()->is('blogs')?' custom-nav-active':'' }}"
                                    href="{{ url('blogs') }}">Blog</a></li>
                            <li class="nav-item"><a class="nav-link {{ request()->is('faq')?' custom-nav-active':'' }}"
                                    href="{{ url('faq') }}">FAQ</a></li>
                            <li class="nav-item"><a
                                    class="nav-link {{ request()->is('contact')?' custom-nav-active':'' }}"
                                    href="{{ url('contact') }}">Contact</a></li>
                            <li class="nav-item"><a
                                    class="nav-link {{ request()->is('ecommerce/vendors')?' custom-nav-active':'' }}"
                                    href="{{ url('ecommerce/vendors') }}">Vendors</a></li>
                        </ul>
                    </div>
                </div>
            </nav>
            ...
            <div class="offcanvas offcanvas-start" tabindex="-1" id="mobileMenu" aria-labelledby="mobileMenuLabel">
                ...
                <div class="offcanvas-body">
                    <ul class="navbar-nav">
                        <li class="nav-item"><a class="nav-link {{ request()->is('/')?' custom-nav-active':'' }}"
                                href="{{ url('/') }}">Home</a></li>
                        <li class="nav-item"><a class="nav-link {{ request()->is('blogs')?' custom-nav-active':'' }}"
                                href="{{ url('blogs') }}">Blog</a></li>
                        <li class="nav-item"><a class="nav-link {{ request()->is('faq')?' custom-nav-active':'' }}"
                                href="{{ url('faq') }}">FAQ</a></li>
                        <li class="nav-item"><a class="nav-link {{ request()->is('contact')?' custom-nav-active':'' }}"
                                href="{{ url('contact') }}">Contact</a></li>
                        <li class="nav-item"><a
                                class="nav-link {{ request()->is('ecommerce/vendors')?' custom-nav-active':'' }}"
                                href="{{ url('ecommerce/vendors') }}">Vendors</a></li>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            searchBox.addEventListener('keyup', function() {
                ...
                timeout = setTimeout(() => {
                    fetch(
                            `/restaurant/live-search?query=${encodeURIComponent(query)}&type=${type}`)
                        .then(response => response.json())
                        .then(data => {
                            ...
                            if (data.length > 0) {
                                data.forEach(item => {
                                    ...
                                    div.className =
                                        'search-item list-group-item list-group-item-action d-flex justify-content-between align-items-center';
                                    ...
                                    `;
                                    div.onclick = () => window.location.href = item
                                        .url;
