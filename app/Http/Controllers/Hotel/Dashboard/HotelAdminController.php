...
class HotelAdminController extends Controller
{
    ...
    public function updatevendordetails()
    {
        try {
            ...
            return view(view: 'Hotel.dashboard.vendor.updatevendordetails', data: compact('zones','vendorDetails', 'country', 'appsettings', 'cms_pages','states','cities','subcities'));
        } catch (\Exception $e) {
    ...
    public function updatevendorbankdetails()
    {
        ...
        try {
            ...
            return view('Hotel.dashboard.vendor.updatevendorbankdetails', compact('VendorBankDetails', 'appsettings', 'cms_pages'));
        } catch (\Exception $e) {
